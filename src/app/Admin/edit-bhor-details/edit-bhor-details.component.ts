...
@Component({
  selector: 'app-edit-bhor-details',
  templateUrl: './edit-bhor-details.component.html',
  styleUrls: ['./edit-bhor-details.component.css']
})
export class EditBhorDetailsComponent {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(val => {
      ...
      this.service.getBhorDetailsById(this.villageId).subscribe({
        next: (res) => {
  ...
  updateVillage() {
    ...
    this.service.updateBhorById(this.villageId, formData).subscribe(res => {
      console.log("Updated data", formData);
      console.log(res.message);
      this.toastr.success('Village Updated successfully!', 'Success');
      this.villageForm.reset();
      this.router.navigate(['adminhome/bhor_village_data'])
    })
