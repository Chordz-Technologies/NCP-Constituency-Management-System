...
@Component({
  selector: 'app-bhor-details',
  templateUrl: './bhor-details.component.html',
  styleUrls: ['./bhor-details.component.css']
})
export class BhorDetailsComponent {
  ...
  getVillageList() {
    this.service.getBhorDetails().subscribe({
      next: (res: any) => {
  ...
  edit(id: number) {
    this.router.navigate(['adminhome/edit_bhor_village_data/', id]);
  }
