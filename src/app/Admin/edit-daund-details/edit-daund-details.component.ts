...
@Component({
  selector: 'app-edit-daund-details',
  templateUrl: './edit-daund-details.component.html',
  styleUrls: ['./edit-daund-details.component.css']
})
export class EditDaundDetailsComponent {
  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe(val => {
      ...
      this.service.getDaundDetailsById(this.villageId).subscribe({
        next: (res) => {
  ...
  updateVillage() {
    ...
    this.service.updateDaundById(this.villageId, formData).subscribe(res => {
      ...
      this.villageForm.reset();
      this.router.navigate(['adminhome/duand_village_data'])
    })
